...
INSERT INTO train (id, name, source_station, destination_station, total_capacity,ticket_price) VALUES
-- Scenario 1: Multiple trains for the SAME Source and SAME Destination
(10000, 'Mumbai-Pune Intercity Exp', 'Mumbai', 'Pune', 1200, 250),
(10001, 'Deccan Queen', 'Mumbai', 'Pune', 1100, 400),
(10002, 'Sinhagad Express', 'Mumbai', 'Pune', 1500, 500),

-- Scenario 2: Same Source, Different Destinations
(10003, 'Howrah Mail', 'Mumbai', 'Kolkata', 1800, 2500),
(10004, 'Punjab Mail', 'Mumbai', 'Firozpur', 1700, 1300),
(10005, 'Konkan Kanya Exp', 'Mumbai', 'Madgaon', 1300, 1700),

-- Scenario 3: Different Sources, Same Destination (New Delhi)
(10006, 'Rajdhani Express', 'Mumbai', 'New Delhi', 900, 2200),
(10007, 'Tamil Nadu Express', 'Chennai', 'New Delhi', 1100, 2500),
(10008, 'Karnataka Express', 'Bengaluru', 'New Delhi', 1250, 2450),
(10009, 'Purushottam Express', 'Puri', 'New Delhi', 1600, 2100),

-- Scenario 4: Same Source (Bengaluru), Different Destinations
(10010, 'Brindavan Express', 'Bengaluru', 'Chennai', 1400, 400),
(10011, 'Lalbagh Express', 'Bengaluru', 'Chennai', 1400, 600),
(10012, 'Udyan Express', 'Bengaluru', 'Mumbai', 1200, 1900),

-- Scenario 5: Same Destination (Kolkata/Howrah), Different Sources
(10013, 'Gitanjali Express', 'Mumbai', 'Kolkata', 1500, 2400),
(10014, 'Coromandel Express', 'Chennai', 'Kolkata', 1650, 2100),
(10015, 'Saraighat Express', 'Guwahati', 'Kolkata', 1350, 700),

-- Scenario 6: Unique Routes (No common source/destination with others)
(10016, 'Lucknow Mail', 'Lucknow', 'New Delhi', 1400, 150),
(10017, 'Sabarmati Express', 'Ahmedabad', 'Varanasi', 1600, 1500),
(10018, 'Sanghamitra Express', 'Bengaluru', 'Patna', 1800, 2300),
(10019, 'Himsagar Express', 'Kanyakumari', 'Jammu Tawi', 1500, 2500),
(10020, 'Golden Temple Mail', 'Amritsar', 'Mumbai', 1750, 2000),

-- Scenario 7: High Capacity Short Distance
(10021, 'Chennai-Mysuru Shatabdi', 'Chennai', 'Mysuru', 800, 800),
(10022, 'Vande Bharat Exp', 'New Delhi', 'Varanasi', 1128, 1650),
(10023, 'Kashi Vishwanath Exp', 'Varanasi', 'New Delhi', 1400, 1650),
(10024, 'Gatimaan Express', 'Hazrat Nizamuddin', 'Agra', 750, 250),
(10025, 'Gujrat Mail', 'Ahmedabad', 'Surat', 200, 200);
